...
poblacion = generarPoblacionInicial(n_pobl, n_votes, quorum_min) # generar la poblacion inicial
#ordenar la poblacion de acuerdo al fitness
pobl_actual_ord = ordenarPoblacion(poblacion, puntos)


#hasta cuando?
while True:
  #llama a la funcion generar nueva poblacion
  ...
  #guardar la poblacion anterior (opcional,TODO: guardar en nuevo eje)
  #pobl_all.append(pobl_new_ord)
